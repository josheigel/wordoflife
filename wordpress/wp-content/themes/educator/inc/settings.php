		...
		'layout'=>array(
			...
			'content'=>array(
				...
				'dynamiccontent'=>array(
					'type'=>'check','name'=>'dynamiccontent','value'=>'1','ttl'=>'Load content dynamically', 'hint'=>'Turn on if you want to use dynamic content loader'
				),
				'dpagination'=>array(
					'type'=>'check','name'=>'dpagination','value'=>'1','ttl'=>'Load posts dynamically', 'hint'=>'Turn on if you want to use dynamic posts loader'
				),
				'related'=>array(
